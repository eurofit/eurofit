...
export const pages_blocks_product_list = pgTable(
  "pages_blocks_product_list",
  {
    ...
    id: varchar("id").primaryKey(),
    icon: varchar("icon"),
    iconFillColor: varchar("icon_fill_color"),
    ...
    link_label: varchar("link_label").default("View more"),
    ...
    styles_cardBg: varchar("styles_card_bg"),
    styles_cardFg: varchar("styles_card_fg"),
    blockName: varchar("block_name"),
  },
  (columns) => [
